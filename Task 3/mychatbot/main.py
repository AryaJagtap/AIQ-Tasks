...
GOOGLE_API_KEY = "AIzaSyDBbXhOWZvwzl2H7hhFZbaq2OFEKo7gGLo"
PINECONE_API_KEY = "pcsk_2ggAsb_Cxxikpx3haPvsjvUkaS11Fz3Sc9nfpkb96owQgo7eVnY8m83ZhhR3VYfRgtsAWX"
...
def initialize_rag_system():
    ...
    llm = ChatGoogleGenerativeAI(
        model="gemini-2.5-flash", # Maintained 1.5-flash as per your request/compatibility
        temperature=0.3
    )
    ...
    # MODIFICATION: Returning individual components to handle images/files manually if needed
...
with st.sidebar:
    ...
    st.markdown("---")
    st.caption("A.I.Q RailSupport v1.0")
